...
public final class RadarServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<RadarGrpc.RadarRequest,
      RadarGrpc.Infraction> getProcessRadarMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "processRadar",
      requestType = RadarGrpc.RadarRequest.class,
      responseType = RadarGrpc.Infraction.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<RadarGrpc.RadarRequest,
      RadarGrpc.Infraction> getProcessRadarMethod() {
    io.grpc.MethodDescriptor<RadarGrpc.RadarRequest, RadarGrpc.Infraction> getProcessRadarMethod;
      ...
      synchronized (RadarServiceGrpc.class) {
        if ((getProcessRadarMethod = RadarServiceGrpc.getProcessRadarMethod) == null) {
          RadarServiceGrpc.getProcessRadarMethod = getProcessRadarMethod = 
              io.grpc.MethodDescriptor.<RadarGrpc.RadarRequest, RadarGrpc.Infraction>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "RadarService", "processRadar"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  RadarGrpc.RadarRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  RadarGrpc.Infraction.getDefaultInstance()))
  ...
  public static abstract class RadarServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void processRadar(RadarGrpc.RadarRequest request,
                             io.grpc.stub.StreamObserver<RadarGrpc.Infraction> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                RadarGrpc.RadarRequest,
                RadarGrpc.Infraction>(
  ...
  public static final class RadarServiceBlockingStub extends io.grpc.stub.AbstractStub<RadarServiceBlockingStub> {
    ...
    /**
     */
    public RadarGrpc.Infraction processRadar(RadarGrpc.RadarRequest request) {
  ...
  public static final class RadarServiceFutureStub extends io.grpc.stub.AbstractStub<RadarServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<RadarGrpc.Infraction> processRadar(
        RadarGrpc.RadarRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PROCESS_RADAR:
          serviceImpl.processRadar((RadarGrpc.RadarRequest) request,
              (io.grpc.stub.StreamObserver<RadarGrpc.Infraction>) responseObserver);
          break;
        default:
  ...
  private static abstract class RadarServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return RadarGrpc.getDescriptor();
    }
